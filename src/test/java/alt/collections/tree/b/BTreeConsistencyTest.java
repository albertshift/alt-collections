...
public class BTreeConsistencyTest {
	...
	public void test() {
		...
		Tree<Integer, Integer> testMap = BTree.newInstance(3, Comparators.INTEGER);
	...
	private void testLoop(TreeMap<Integer, Integer> controlMap, Tree<Integer, Integer> testMap) {
